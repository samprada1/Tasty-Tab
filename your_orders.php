                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item"> <a class="nav-link active" href="order_kanban.php">Order Board <span class="sr-only"></span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="order_history.php">Order History <span class="sr-only"></span></a> </li>
							<?php
						if(empty($_SESSION["user_id"]))
							{
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                if(!mysqli_num_rows($query_res) > 0) {
                                                    echo '<tr><td colspan="6"><center>You have No active orders. </center></td></tr>';
                                                } else {
                                        ...
                                        <table class="table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                if(!mysqli_num_rows($query_history) > 0) {
                                                    echo '<tr><td colspan="6"><center>No order history available. </center></td></tr>';
                                                } else {
