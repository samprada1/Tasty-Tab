...
if(isset($_POST['submit']))          
{
    ...
    // Add Trisara Restaurant
    $sql = "INSERT INTO restaurant (title, email, phone, url, o_hr, c_hr, o_days, address, c_id, image) 
            VALUES ('Trisara Restaurant', 'trisara@example.com', '9800000000', 'trisara.com', '10:00 AM', '10:00 PM', 'Mon-Sun', 'Kathmandu, Nepal', 1, 'trisara.jpg')";
    mysqli_query($db, $sql);
}
